...
AUTOENCODER_PATH = os.path.join(MODEL_DIR, 'autoencoder.h5.b64')
ENCODER_PATH = os.path.join(MODEL_DIR, 'encoder.h5.b64')
THRESHOLD_PATH = os.path.join(MODEL_DIR, 'threshold.json')
STATE_PATH = os.path.join(MODEL_DIR, 'state.json')


def load_model_b64(path: str) -> tf.keras.Model:
    """Load a Keras model from a base64-encoded H5 file."""
